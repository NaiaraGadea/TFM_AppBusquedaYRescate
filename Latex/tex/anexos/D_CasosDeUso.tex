\chapter{Casos de uso}\label{CasosDeUso}

En este anexo se desarrolla cada uno de los casos de uso seleccionados como guía para desarrollar la aplicación. Cada casos de uso se relaciona con uno o varios de los requisitos definidos.
% ----------------------------------------------------
% ----------------------------------------------------
% Caso de uso 01
\begin{table}[htbp]
...
\cellcolor[HTML]{EFEFEF}\textbf{Urgencia}                & Alta\\
\hline
\cellcolor[HTML]{EFEFEF}\textbf{Requisitos Funcionales Relacionados}                & {RF-02, RF-03, RF-05}\\
\hline
