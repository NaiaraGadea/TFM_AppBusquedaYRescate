\chapter{DESCRIPCIÓN DEL PROYECTO}
    ...
    https://www.revistas.uma.es/index.php/boletin-criminologico/article/view/6833/6361
    
    \textcolor{red}{El contexto y la motivación detrás del proyecto.}

    En el mundo desaparecen miles personas al año, por causas cómo desastres naturales, conflictos armados, aumento del envejecimiento de la población y enfermedades de salud mental. En España, en el año 2024 hubo unas 16.000 denuncias. Actualmente siguen activas, solo del año pasado, unas 700 denuncias, más de 700 familias que conviven constantemente con la incertidumbre y la angustia de no saber el paradero de su ser querido. \cite{DatosDesaparecidos2024}
    
    Por estas cifras y porque todas las personas tienen derecho a su búsqueda y localización, la búsqueda de personas desaparecidas supone un reto y un esfuerzo actual relevante de carácter social y humanitario\cite{garcia2019personas}. Es por esto que si puedo ayudar a mejorar un poquito el mundo en este ámbito con mis conocimientos de Ingeniería Biomédica quiero aportar mi granito de arena.

    En la sociedad en la que vivimos tenemos a disposición multitud de herramientas tecnológicas que permiten localizar a una persona. Existen drones con visión artificial y sistemas GPS, además de aplicaciones como AlertCops que facilita la seguridad ciudadana y pueden ser de gran ayuda en las búsquedas. Aunque estas tecnologías salvan vidas y dan esperanza, todavía hay espacios de la búsqueda que son bastante deficientes, cómo el hecho de que la mayoría de estos sistemas se basan en la idea de que la persona desaparecida lleve consigo algún tipo de dispositivo electrónico .

    Es vital llenar los huecos que quedan en términos de búsquedas de personas desaparecidas, para minimizar la gravedad de estos sucesos y favorecer una mayor seguridad de nuestra sociedad y país.

    \textcolor{red}{Relación con la ingeniería biomédica con la problemática de las personas desaparecidas}

    \textcolor{red}{¿Incluir esta parte en motivación?}

    La ingeniería biomédica combina conocimientos de salud y tecnología para mejorar la vida y la salud de las personas mediante el uso y desarrollo de soluciones innovadoras. Permite desarrollar desde tratamientos o diagnósticos personalizados, hasta dispositivos de asistencia. Pero no solo eso, la ingeniería biomédica también ocupa la gestión y tratamiento seguro y ético de los datos personales, garantizando la privaciad y confidencialidad de la información. Por todo ello la ingeniería biomédica puede ser una estrategia poderosa para proteger y salvar vidas.
    ...
    En este trabajo me centraré en usar mis conocimientos para definir una app que permita gestionar y coordinar a las diferentes personas o  equipos que participan en la búsqueda de una persona desaparecida, gestionar toda la información de la búsqueda y donde se recopilen datos para que se pueda trabajar con algoritmos predictivos de localización de la persona en base al resultado de otras búsquedas y la información propia de la persona desaparecida. Este último punto en principio será teórico puesto que no puedo acceder a los datos.


    \textcolor{red}{En este documento se prentende realizar una revisión bibliográfica de los casos de personas desaparecidas en España, un prototipo sencillo de la aplicación de apoyo a la gestión y búsqueda de personas desaparecidas y todo lo relacionado con su desarrollo. Con el objetivo de obtener al final un PMV con el que realizar una validación realista de su posible incorporcación al mercado.}


    \textcolor{red}{Tambien se pretende explorar las posibilidades de usar algoritmos de predicción de la localización de la persona desparecida en base a los datos médicos o fisiológicos de la persona desaparecida.}
...
La app de búsqueda y rescate de personas desaparecidas que se presenta en este trabajo requiere de la gestión y análisis de datos de personas desaparecidas, grupos de rescate, voluntarios e instituciones, y en el caso de personas desparecidas también se puede trabajar con sus datos médicos como información de enfermedades o trastornos. Además, gracias a los conocimeintos de ingeniería biomédica se pueden aplicar técnicas de análisis predictivo para el apoyo en las desapariciones, y tambien identificar patrones y factores de riesgo y de esta forma mejorar la efectividad de las búsquedas. Los conocimientos en ingeniería biomédica permiten integrar los distintos sistemas de información para que los datos sean accesibles, sean compartidos de forma segura y eficiente entre los involucrados y responsables. 

Como la mayoría de datos que se van a tratar en la app son datos sensibles, como información médica y personal, requiere tener muy en cuenta la protección de esos datos y la privacidad.

Incluso se podría llegar a asociar a dispositivos con sensores que monitoricen a los participantes u otros elementos como drones.

En esta app, su enfoque en la gestión y análisis de datos, la predicción de patrones y la protección de la información la conectan con principios y técnicas de la ingeniería biomédica. Aunque la app no esté enfocado en dispositivos médicos o tratamientos, su uso de tecnologías de datos y su contribución a la seguridad y bienestar de las personas conectan este trabao con los principios de la ingeniería biomédica.



La automatización de alertas en aplicaciones de seguridad y de colaboración ciudadana, pueden transformar la forma en que los organismos de rescate gestionan los recursos y aumentan las probabilidades de éxito en situaciones críticas para poder salvar vidas. 
    ...
    Proporcionando a los profesionales herramientas que faciliten su trabajo. 

    Además, gracias a la herramienta que se pretende desarrollar se promueve la colaboración entre los distintos organismos, grupos de rescate, asociaciones y civiles en general.
...
Por otro lado, la Fundación ANAR fundada en 2017 por el ministerio del interior se encarga de menores desaparecidos.
    ...
    \textcolor{red}{OTRO APARTADO?, RESPONDER A ESA PREGUNTA:}

    Probablemente muchos se pregunten de qué forma se asocia la ingeniería biomédica con un softare de gestión y coordinación de personas desaparecidas. 
